...
export default class Haksa extends React.Component {
  ...
  async Login(userId, passwd) {
    try {
      ...
      if (this.sauSession.isLoginState) this.SaveSession();
  ...
  async LoginJsp(userId, passwd) {
    ...
    return this.LoginRegistrationToken();
  }
  ...
  async LoginRegistrationToken() {
    ...
    return this.LoginRegistrationSession();
  }
  ...
  async LoginRegistrationSession() {
    ...
    return this.LoginDistributionToken();
  }
  ...
  async LoginCm() {
    try {
      ...
      isLogined = await body.indexOf('blank.jsp');
